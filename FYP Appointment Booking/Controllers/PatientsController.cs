...
namespace FYP_Appointment_Booking.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DOB,Email,Address,DoctorId")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DOB,Email,Address,DoctorId")] Patient patient)
        {
            if (id != patient.Id)
            {
                return NotFound();
