    ...
    public class EmailNotification : Controller
    {
        ...
        public async Task<ActionResult> Index(EmailNotifyViewModel model)
        {
            try
            {
                ...
                {
                    // Initialization.  
                    string emailMsg = "Dear " + model.ToEmail + ", <br /><br />This is a test <b style='color: red'> Reminder </b><br />  <a href = 'https://localhost:44398/Appointments/Edit/1'> Confirm </a><br /> " + "<a href = 'https://localhost:44398/Appointments/Edit/1'>Reschedule</a> <br />" + " <br /> Kind Regards, <br />CUH Appointments";
